...
export default function NSTEMIPage() {
  ...
  const [medications, setMedications] = useState([
    { name: 'Nitrates -', dosage: '300mg', route: 'oral', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Prasugrel**', dosage: '60 mg (10mg vial)', route: 'PO', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Ticagrelor', dosage: '180 mg (90mg)', route: 'PO', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Heparin infusion', dosage: '12IU/ kg/ hr', route: 'IV', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'LMWH', dosage: 'IV then sc bid (20, 40 & 60)', route: '', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Enoxaparin', dosage: '1mg/kg', route: '', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Beta blocker ****', dosage: '25/50 mg', route: '', administered: false, comments: '', time: '', givenBy: '' },
    { name: 'Emesat', dosage: '8mg', route: '', administered: false, comments: '', time: '', givenBy: '' },
  ])
  ...
  const handleAddMedication = () => {
    setMedications([...medications, { name: '', dosage: '', route: '', administered: false, comments: '', time: '', givenBy: '' }])
  }
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Submitting NSTEMI data:', { patientInfo, medications, investigations, procedures })
  ...
  return (
        ...
        <>
          <Card className="w-full mx-auto">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-center">NSTEMI</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold">Medication prescription (NSTEMI)</h3>
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Comments on deviation</TableHead>
                        <TableHead>Time of administration</TableHead>
